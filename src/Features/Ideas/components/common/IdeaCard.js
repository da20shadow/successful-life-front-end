    ...
    return (
        <>
            <div
                ...
                <h2 onClick={() => setOpenViewIdeaModal(true)}
                    className="cursor-pointer text-gray-700 dark:text-gray-300 text-xl font-bold border-b mb-4">{idea.title}</h2>
            ...
            >
                ...
                <DialogTitle className={'text-center text-rose-900 dark:text-rose-400'}>
                ...
                <DialogContent>
                    ...
                    <DialogContentText sx={{textAlign: 'center'}} id="alert-dialog-slide-description">
                            ...
                            <span className="italic"> "{idea.title}" </span>?
                    </DialogContentText>
            ...
            >
                ...
                <DialogContent className={'bg-white dark:bg-gray-700'}>
                    ...
                    <h4 className={'text-xl text-gray-700 dark:text-gray-300 border-b'}><TextSnippetIcon/> Idea
                        Description</h4>
